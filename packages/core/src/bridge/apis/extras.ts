...
// under @snowluma/bridge/oidb-services/extras.

import type { MediaIndexNode } from './shared';
import type { BridgeContext } from '../bridge-context';
import { GroupTodo } from '@snowluma/bridge/oidb-services/extras/group-todo';
import { GetStrangerStatus, type StrangerStatus as NamespaceStrangerStatus } from '@snowluma/bridge/oidb-services/extras/get-stranger-status';
import {
  FetchAiVoiceList,
  type AiVoiceCategory as NamespaceAiVoiceCategory,
} from '@snowluma/bridge/oidb-services/extras/fetch-ai-voice-list';
import { FetchAiVoice } from '@snowluma/bridge/oidb-services/extras/fetch-ai-voice';
