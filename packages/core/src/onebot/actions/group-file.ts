...
export function register(h: ApiHandler, ctx: ApiActionContext): void {
  ...
  h.registerAction('delete_group_file', async (params) => {
    ...
    await ctx.bridge.apis.groupFile.delete(groupId, fileId);
    return okResponse();
  });
  ...
  h.registerAction('move_group_file', async (params) => {
    ...
    await ctx.bridge.apis.groupFile.move(groupId, fileId, parentDirectory, targetDirectory);
    return okResponse();
  });
  ...
  h.registerAction('rename_group_file_folder', async (params) => {
    ...
    await ctx.bridge.apis.groupFile.renameFolder(groupId, folderId, newName);
    return okResponse();
  });
